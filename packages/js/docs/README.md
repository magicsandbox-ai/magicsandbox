...
`@magicsandbox.ai/docs` turns a documentation Markdown file into a [Magic Sandbox](https://magicsandbox.ai) App.
...
`@magicsandbox.ai/docs` installs [@magicsandbox.ai/dev](https://github.com/magicsandbox-ai/magicsandbox/tree/main/packages/js/dev) as a dependency.

## Usage

Set up a folder structured like so, where `index.md` is your documentation Markdown file. `@magicsandbox.ai/docs` will initialize these files for you if needed:
